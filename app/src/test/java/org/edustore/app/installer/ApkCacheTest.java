...
public class ApkCacheTest {
    ...
    public void testGetApkDownloadPath() {
        assertEquals("Should be in folder based on repo hostname",
                new File(cacheDir, "f-droid.org--1/org.edustore.app_1008000.apk"),
                ApkCache.getApkDownloadPath(context,
                        "https://f-droid.org/repo/org.edustore.app_1008000.apk"));
        ...
        assertEquals("Should work for OTA files also",
                new File(cacheDir, "f-droid.org--1/org.edustore.app.privileged.ota_2110.zip"),
                ApkCache.getApkDownloadPath(context,
                        "http://f-droid.org/fdroid/repo/org.edustore.app.privileged.ota_2110.zip"));
