...
public class InstallerService extends JobIntentService {
    ...
    private static final String ACTION_INSTALL = "org.edustore.app.installer.InstallerService.action.INSTALL";
    private static final String ACTION_UNINSTALL = "org.edustore.app.installer.InstallerService.action.UNINSTALL";
