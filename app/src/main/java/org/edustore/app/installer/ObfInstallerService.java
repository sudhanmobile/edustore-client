...
public class ObfInstallerService extends IntentService {
    ...
    private static final String ACTION_INSTALL_OBF = "org.edustore.app.installer.action.INSTALL_OBF";

    private static final String EXTRA_OBF_PATH = "org.edustore.app.installer.extra.OBF_PATH";
