...
import org.edustore.app.privileged.IPrivilegedCallback;
import org.edustore.app.privileged.IPrivilegedService;
...
public class PrivilegedInstaller extends Installer {
    ...
    private static final String PRIVILEGED_EXTENSION_SERVICE_INTENT
            = "org.edustore.app.privileged.IPrivilegedService";
