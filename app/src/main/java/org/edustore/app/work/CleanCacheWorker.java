 ...
 * running, then APKs can remain in {@link org.edustore.app.installer.ApkFileProvider}
 */
public class CleanCacheWorker extends Worker {
    ...
    /**
     * {@link org.edustore.app.installer.Installer} instances copy the APK into
     ...
     * {@link org.edustore.app.net.DownloaderFactory#create(Context, String)}, e.g. "dl-*"
     */
