...
import org.edustore.app.installer.ApkFileProvider;
import org.edustore.app.installer.InstallHistoryService;
import org.edustore.app.installer.SessionInstallManager;
import org.edustore.app.nearby.PublicSourceDirProvider;
...
import org.edustore.app.net.DnsCache;
import org.edustore.app.net.DownloaderFactory;
import org.edustore.app.panic.HidingManager;
import org.edustore.app.receiver.DeviceStorageReceiver;
...
public class FDroidApp extends Application implements androidx.work.Configuration.Provider {
    ...
    /**
     * Asks if the current process is "org.edustore.app:acra".
     * <p>
     ...
     * @see org.edustore.app.work.FDroidMetricsWorker
     * @see org.edustore.app.work.UpdateWorker
