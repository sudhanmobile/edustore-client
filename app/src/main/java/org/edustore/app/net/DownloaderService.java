 ...
 * @see org.edustore.app.installer.InstallManagerService
 */
public class DownloaderService extends JobIntentService {
    private static final String TAG = "DownloaderService";
    private static final int JOB_ID = TAG.hashCode(); // 1964029344

    private static final String ACTION_QUEUE = "org.edustore.app.net.DownloaderService.action.QUEUE";

    public static final String ACTION_STARTED = "org.edustore.app.net.Downloader.action.STARTED";
    public static final String ACTION_PROGRESS = "org.edustore.app.net.Downloader.action.PROGRESS";
    public static final String ACTION_INTERRUPTED = "org.edustore.app.net.Downloader.action.INTERRUPTED";
    public static final String ACTION_CONNECTION_FAILED = "org.edustore.app.net.Downloader.action.CONNECTION_FAILED";
    public static final String ACTION_COMPLETE = "org.edustore.app.net.Downloader.action.COMPLETE";

    public static final String EXTRA_DOWNLOAD_PATH = "org.edustore.app.net.Downloader.extra.DOWNLOAD_PATH";
    public static final String EXTRA_BYTES_READ = "org.edustore.app.net.Downloader.extra.BYTES_READ";
    public static final String EXTRA_TOTAL_BYTES = "org.edustore.app.net.Downloader.extra.TOTAL_BYTES";
    public static final String EXTRA_ERROR_MESSAGE = "org.edustore.app.net.Downloader.extra.ERROR_MESSAGE";
    private static final String EXTRA_REPO_ID = "org.edustore.app.net.Downloader.extra.REPO_ID";
    private static final String EXTRA_MIRROR_URL = "org.edustore.app.net.Downloader.extra.MIRROR_URL";
    /**
     ...
     */
    public static final String EXTRA_CANONICAL_URL = "org.edustore.app.net.Downloader.extra.CANONICAL_URL";
