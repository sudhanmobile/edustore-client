...
import org.edustore.app.installer.ErrorDialogActivity;
 ...
 * <p>
 * As defined in {@link org.edustore.app.installer.InstallManagerService}, the
...
public final class AppUpdateStatusManager {
     ...
     */
    public static final String BROADCAST_APPSTATUS_LIST_CHANGED = "org.edustore.app.installer.appstatus.listchange";

    /**
     * Broadcast when an app begins the download/install process (either manually or via an automatic download).
     */
    public static final String BROADCAST_APPSTATUS_ADDED = "org.edustore.app.installer.appstatus.appchange.add";

    /**
     * When the {@link AppUpdateStatus#status} of an app changes or the download progress for an app advances.
     */
    public static final String BROADCAST_APPSTATUS_CHANGED = "org.edustore.app.installer.appstatus.appchange.change";
     ...
     */
    public static final String BROADCAST_APPSTATUS_REMOVED = "org.edustore.app.installer.appstatus.appchange.remove";
